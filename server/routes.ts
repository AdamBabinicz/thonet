...
export async function registerRoutes(app: Express): Promise<Server> {
  app.get("/", (req, res) => {
    res.send(
      "Welcome to the Thonet Placeholder API! Try /api/placeholder/200/150?theme=chair"
    );
  });
      ...
      case "chair":
        svg = `
          <svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="5" y="5" width="${parseInt(width) - 10}" height="${
          parseInt(height) - 10
        }"
                  fill="none" stroke="#2C3E50" stroke-width="4" stroke-dasharray="8,4"/>
            <ellipse cx="${parseInt(width) / 2}" cy="${
          parseInt(height) * 0.45
        }" rx="60" ry="25"
            ...
            <rect x="${parseInt(width) / 2 - 45}" y="${
          parseInt(height) * 0.5
        }" width="8" height="80"
                  fill="url(#woodGradient)" stroke="#654321" stroke-width="2" rx="4"/>
            <rect x="${parseInt(width) / 2 + 37}" y="${
          parseInt(height) * 0.5
        }" width="8" height="80"
                  fill="url(#woodGradient)" stroke="#654321" stroke-width="2" rx="4"/>
            <rect x="${parseInt(width) / 2 - 35}" y="${
          parseInt(height) * 0.3
        }" width="8" height="100"
                  fill="url(#woodGradient)" stroke="#654321" stroke-width="2" rx="4"/>
            <rect x="${parseInt(width) / 2 + 27}" y="${
          parseInt(height) * 0.3
        }" width="8" height="100"
                  fill="url(#woodGradient)" stroke="#654321" stroke-width="2" rx="4"/>
            <circle cx="${parseInt(width) * 0.85}" cy="${
          parseInt(height) * 0.2
        }" r="25"
                    fill="#FFD700" stroke="#FF6B35" stroke-width="3"/>
            <text x="${parseInt(width) * 0.85}" y="${
          parseInt(height) * 0.25
        }" text-anchor="middle"
      ...
      case "workshop":
        svg = `
          ...
          parseInt(height) - 10
            ...
            <rect x="20" y="${parseInt(height) * 0.6}" width="${
          parseInt(width) - 40
        }" height="15"
            ...
            <rect x="${parseInt(width) - 33}" y="${
          parseInt(height) * 0.75
        }" width="8" height="40"
                  fill="#8B4513" stroke="#654321" stroke-width="1"/>
            <rect x="${parseInt(width) * 0.3}" y="${
          parseInt(height) * 0.3
        }" width="40" height="60"
                  fill="#708090" stroke="#2F4F4F" stroke-width="3" rx="5"/>
            <ellipse cx="${parseInt(width) * 0.32}" cy="${
          parseInt(height) * 0.25
        }" rx="8" ry="15"
                     fill="url(#steamGradient)"/>
            <ellipse cx="${parseInt(width) * 0.38}" cy="${
          parseInt(height) * 0.2
        }" rx="6" ry="12"
                     fill="url(#steamGradient)"/>
            <ellipse cx="${parseInt(width) * 0.44}" cy="${
          parseInt(height) * 0.15
        }" rx="4" ry="8"
                     fill="url(#steamGradient)"/>
            ...
            <rect x="${parseInt(width) * 0.15}" y="${
          parseInt(height) * 0.5
        }" width="25" height="4"
                  fill="#C0C0C0" stroke="#808080" stroke-width="1"/>
            <rect x="${parseInt(width) * 0.12}" y="${
          parseInt(height) * 0.52
        }" width="8" height="8"
                  fill="#8B4513" stroke="#654321" stroke-width="1"/>
            <ellipse cx="${parseInt(width) * 0.8}" cy="${
          parseInt(height) * 0.3
        }" rx="35" ry="25"
                     fill="#FFFACD" stroke="#DAA520" stroke-width="3"/>
            <text x="${parseInt(width) * 0.8}" y="${
          parseInt(height) * 0.32
        }" text-anchor="middle"
      ...
      case "portrait":
        svg = `
          <svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="10" y="10" width="${parseInt(width) - 20}" height="${
          parseInt(height) - 20
        }"
                  fill="none" stroke="#DAA520" stroke-width="6"/>
            <rect x="15" y="15" width="${parseInt(width) - 30}" height="${
          parseInt(height) - 30
        }"
          ...
          parseInt(height) * 0.4
            ...
            <path d="M ${parseInt(width) / 2 - 45} ${parseInt(height) * 0.3}
                     ...
                     ${parseInt(width) / 2 - 45} ${parseInt(height) * 0.3}"
                  fill="#8B4513" stroke="#654321" stroke-width="2"/>
            <ellipse cx="${parseInt(width) / 2 - 15}" cy="${
          parseInt(height) * 0.38
        }" rx="4" ry="6" fill="#000"/>
            <ellipse cx="${parseInt(width) / 2 + 15}" cy="${
          parseInt(height) * 0.38
        }" rx="4" ry="6" fill="#000"/>
            ...
            <rect x="${parseInt(width) / 2 - 35}" y="${
          parseInt(height) * 0.65
        }" width="70" height="60"
                  fill="#2F4F4F" stroke="#1C1C1C" stroke-width="2"/>
            <rect x="${parseInt(width) / 2 - 30}" y="${
          parseInt(height) * 0.7
        }" width="60" height="8"
                  fill="#FFFACD" stroke="#DAA520" stroke-width="1"/>
            <rect x="${parseInt(width) * 0.1}" y="${
          parseInt(height) * 0.85
        }" width="${parseInt(width) * 0.8}" height="25"
      ...
      case "process":
        svg = `
          <svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="8" y="8" width="${parseInt(width) - 16}" height="${
          parseInt(height) - 16
        }"
            ...
            <path d="M 65 ${parseInt(height) * 0.24} L 85 ${
          parseInt(height) * 0.24
        }"
            ...
            <circle cx="95" cy="${
              parseInt(height) * 0.1
            }" r="3" fill="#E0E0E0" opacity="0.7"/>
            <circle cx="105" cy="${
              parseInt(height) * 0.08
            }" r="2" fill="#E0E0E0" opacity="0.5"/>
            <circle cx="110" cy="${
              parseInt(height) * 0.05
            }" r="1.5" fill="#E0E0E0" opacity="0.3"/>
            <text x="102" y="${parseInt(height) * 0.4}" text-anchor="middle"
                  font-family="Arial, sans-serif" font-size="8" fill="#2F4F4F">PARA</text>
            <path d="M 120 ${parseInt(height) * 0.24} L 140 ${
          parseInt(height) * 0.24
        }"
            ...
            <path d="M 175 ${parseInt(height) * 0.24} L 195 ${
          parseInt(height) * 0.24
        }"
                  stroke="#2F4F4F" stroke-width="3"/>
            ...
            <path d="M 95 ${parseInt(height) * 0.5} Q 100 ${
          parseInt(height) * 0.45
        } 105 ${parseInt(height) * 0.5}"
                  fill="none" stroke="url(#heatGradient)" stroke-width="2"/>
            <path d="M 100 ${parseInt(height) * 0.55} Q 105 ${
          parseInt(height) * 0.5
        } 110 ${parseInt(height) * 0.55}"
                  fill="none" stroke="url(#heatGradient)" stroke-width="2"/>
